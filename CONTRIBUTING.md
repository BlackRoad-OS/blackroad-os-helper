# Contributing to blackroad-os-helper
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-helper.git
cd blackroad-os-helper

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-helper.git
